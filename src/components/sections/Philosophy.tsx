        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          <div className="lg:col-span-7 space-y-16 md:space-y-24">
            <div className="space-y-8">
              ...
              >
                <Sparkles size={12} className="animate-pulse" /> Our Shared Curiosity
              </motion.div>
              ...
              <div className="space-y-12">
                ...
                >
                  BUILT FOR THE<br /> 
                  <span className="font-serif italic font-light text-white/30 lowercase">Curious.</span>
                </motion.h2>
                
                <p className="text-white/70 text-xl md:text-2xl font-light leading-relaxed max-w-2xl font-sans">
                  We’re a home for <span className="text-white font-medium italic">pure creativity</span>—a friendly break from the usual hustle. There's no pressure to pitch or network here; we're just people sharing the simple joy of making things together.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-white/60 font-light leading-relaxed text-lg relative z-10">
                  A relaxed space to share the things that inspire you—from art and music to the weird corners of the web. It's all about genuine connection and good energy.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/60 font-light leading-relaxed text-lg relative z-10">
                  The thrill of the breakthrough. We celebrate those wonderful, messy moments when a side project finally comes to life and you get to share it with friends.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32">
             <div className="space-y-6">
                <div className="bg-primary/90 p-10 md:p-12 text-black shadow-2xl shadow-primary/10 relative overflow-hidden group">
                   ...
                   <div className="text-[10px] font-mono font-black uppercase tracking-[0.4em] mb-12 opacity-40">Our Focus // v1.0</div>
                   <div className="space-y-10 relative z-10">
                      <div className="group/metric">
                         ...
                         <div className="text-[10px] uppercase font-black tracking-[0.2em] opacity-60">Performative Pressure</div>
                      </div>
                      ...
                      <div className="group/metric">
                         ...
                         <div className="text-[10px] uppercase font-black tracking-[0.2em] opacity-60">Shared Curiosity</div>
                      </div>
                   </div>
                </div>
                ...
                <div className="bg-white/3 border border-white/10 p-10 md:p-12 overflow-hidden relative group hover:bg-white/5 hover:border-primary/20 transition-all">
                   <div className="relative z-10 space-y-4">
                      <div className="flex items-center gap-3 text-primary mb-2">
                        <Laptop size={20} />
                        <span className="text-[10px] font-mono font-bold uppercase tracking-widest">Protocol :: Joining In</span>
                      </div>
                      ...
                      <p className="text-white/40 text-base font-light leading-relaxed">
                        We love the "weird" ideas. Come ready to show what you're working on or start a new experiment with the group.
                      </p>
                   </div>
